...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your admin actions</p>

    <form action="authenticate.php" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="username" maxlength="8" placeholder="User Name" required>
